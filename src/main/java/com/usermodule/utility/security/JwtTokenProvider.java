...
//
//    //Storing JWT Secret Key in property file.
...
//        );
//
//        //will give current time and date.
//        Date now = new Date();
//
//        //creating validity of the session. current time(now) + validity (that we have declared).
...
//    }
//
//    //to get username(email) by token.
